...
- [x] README를 내러티브 중심으로 더 선명하게 다듬기
- [x] `examples/`에 새 샘플 추가
- [x] validation에서 얻은 검수 관점을 공개 저장소용 예시에 반영하기
- [ ] 원커맨드 실행기 또는 auto-runner 방향 결정
- [ ] agent-simplify를 메인에 병합할지 RFC로 확정
- [ ] 사실 검증 최소 장치 범위를 spec에 명시
